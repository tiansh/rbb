* [2015-08-03] 2.62 ：修复个人页面的兼容性
* [2014-10-24] 2.61 ：兼容一些改版
* [2014-09-04] 2.60 ：临时修正（应该没用）
* [2014-08-18] 2.59 ：新的 html5 接口链接
* [2014-08-17] 2.58 ：可选不向链接的锚点添加数据（启用后iqiyi视频必须使用生成页面）
* [2014-08-14] 2.57 ：修理视频标签和专题列表部分显示问题
* [2014-08-13] 2.56 ： /video/av 自动跳转 /video/av1/index1.html 处理 iqiyi 可以显示顶栏底栏
* [2014-08-12] 2.55 ：电脑端不显示的默认“生成页面”，所有链接上加hash以解决自动跳转问题，生成页面处理 /video/av/ ，生成页面可以只拿着aid 生成 (#7)
* [2014-08-11] 2.54 ：默认长按菜单出生成页面的链接，彻底解决 (#6)；强制显示“生成页面”链接不再需要 #3 中提到的修改 
* [2014-08-10] 2.53 ：iqiyi使用 secure.bilibili.com/secure, 页面？
